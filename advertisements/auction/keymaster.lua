...
addEventHandler("keymaster:get-key", resourceRoot, function (auction)
    exports.mysql:getConn('mta'):query(
        function (handle, player)
            ...
            outputChatBox("Você recebeu a chave do seu " .. getVehicleFullName(vehicle) .. ".", player, 100, 255, 100)
            outputChatBox("Por favor, pegue no lado norte do estacionamento.", player, 100, 255, 100)
            outputChatBox("Não se esqueça de estacionar seu veículo depois de retirá-lo!", player, 100, 255, 100)
        end,
        {client},
