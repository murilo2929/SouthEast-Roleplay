...
function www_bankofsa_sa()
	...
	setPageTitle(internet_address_label, "Banco de Crédito e Comércio de San Andreas")
	...
	local link_1 = guiCreateLabel(123,107,33,14,"Ofertas",false,bg)
	guiSetFont(link_1,"default-small")
	guiLabelSetColor(link_1,0,51,153)
	
	local link_2 = guiCreateLabel(191,107,80,14,"Contas Correntes",false,bg)
	guiSetFont(link_2,"default-small")
	guiLabelSetColor(link_2,0,51,153)
	
	local link_3 = guiCreateLabel(314,107,32,14,"Empréstimos",false,bg)
	guiSetFont(link_3,"default-small")
	guiLabelSetColor(link_3,0,51,153)
	
	local link_4 = guiCreateLabel(387,107,56,14,"Investimento",false,bg)
	guiSetFont(link_4,"default-small")
	guiLabelSetColor(link_4,0,51,153)
	
	local link_5 = guiCreateLabel(479,107,60,14,"Cartão de débito",false,bg)
	...
	local text = guiCreateLabel(270,155,270,14,"Clique aqui para abrir em um pop-up por meio de uma conexão não segura!",false,bg)
