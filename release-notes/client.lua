...
function showReleases(releases1)
	if GUIEditor.window[1] and isElement(GUIEditor.window[1]) then
		...
		GUIEditor.label[1] = guiCreateLabel(9, 264, 468, 23, "♦ If you discover a bug/glitch while playing, please report it on discord\n♦ Your feedback goes a long way towards making even better!" , false, GUIEditor.window[1])
		guiSetFont(GUIEditor.label[1], "default-small")
		guiLabelSetVerticalAlign(GUIEditor.label[1], "center")
		GUIEditor.button[1] = guiCreateButton(477, 264, 117, 23, "Fechar", false, GUIEditor.window[1])
