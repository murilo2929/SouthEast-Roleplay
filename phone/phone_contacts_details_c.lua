...
function openContactDetails(name, number, yoffset)
	if isPhoneGUICreated() then
		...
		lName_contact_details = guiCreateLabel(margin,posY,lineW,20, "Nome:", false, wPhoneMenu)
		...
		lNumber_contact_details = guiCreateLabel(margin,posY,lineW,20, "Numero:", false, wPhoneMenu)
		...
		lAddress_contact_details = guiCreateLabel(margin,posY,lineW,20, "Endereço:", false, wPhoneMenu)
		...
		lFavo_contact_details = guiCreateLabel(margin,posY,lineW,20, "Favorito:", false, wPhoneMenu)
		fFavo_contact_details = guiCreateCheckBox ( margin+lineW,posY,20,20, "", tonumber(theContact2.entryFavorited) == 1 , false, wPhoneMenu)
		
		local bW, bH = 100, 30
		bUpdate_contact_details = guiCreateButton(margin+bW,posY,bW,bH, "Atualizar", false, wPhoneMenu)
		guiSetEnabled(bUpdate_contact_details, false)
		posY = posY + lineH
		
		bCall1_contact_details = guiCreateButton(margin,posY,bW,bH, "Ligar", false, wPhoneMenu)
		bSMS_contact_details = guiCreateButton(margin+bW+2,posY,bW,bH, "Enviar Mensagem", false, wPhoneMenu)
		--guiSetEnabled(bSMS_contact_details, false)
		posY = posY + bH + 2

		bDelete_contact_details = guiCreateButton(margin,posY,bW,bH, "Deletar", false, wPhoneMenu)
		bCancel2_contact_details = guiCreateButton(margin+bW+2,posY,bW,bH, "Cancelar", false, wPhoneMenu)
		posY = posY + bH + 2
