...
function drawSettings(xoffset, yoffset)
    ...
    settingGuis[3] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Operadora: Global Metro Media", false, settingGuis.main)
    guiSetFont(settingGuis[3], "default-small")

    yoffset = yoffset + smallLine
    settingGuis[4] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Assinante: "..(getPhoneSettings(phone, "boughtByName") or "Desconhecido"):gsub("_", " "), false, settingGuis.main)
    guiSetFont(settingGuis[4], "default-small")

    yoffset = yoffset + smallLine
    settingGuis[29] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Numero: "..phone, false, settingGuis.main)
    guiSetFont(settingGuis[29], "default-small")

    yoffset = yoffset + smallLine
    settingGuis[5] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Data de Registro: "..(getPhoneSettings(phone, "boughtDate") or "Desconhecido"), false, settingGuis.main)
    guiSetFont(settingGuis[5], "default-small")
    

    -----------------------------------------------------
    yoffset = yoffset + 40
    settingGuis[20] = guiCreateLabel(10+xoffset, 10+yoffset, 200, 19, "Ligações", false, settingGuis.main)
    guiSetFont(settingGuis[20], "default-bold-small")
    guiLabelSetVerticalAlign(settingGuis[20], "center")
    guiSetAlpha(guiCreateStaticImage(10+xoffset, 28+yoffset, 200, 1, ":admin-system/images/whitedot.jpg", false, settingGuis.main), 0.1)
    yoffset = yoffset + 3
    local spacing = 7
    settingGuis[21] = guiCreateLabel(20+xoffset, 30+yoffset, smallLine*spacing, smallLine, "Ocultar Número:", false, settingGuis.main)
    guiSetFont(settingGuis[21], "default-small")
    settingGuis[22] = guiCreateButton(20+smallLine*spacing+xoffset, 30+yoffset, 190-smallLine*spacing, smallLine, getPhoneSettings(phone, "isSecret") == 1 and "Ativado" or "Desativado", false, settingGuis.main)
    guiSetFont(settingGuis[22], "default-small")
    yoffset = yoffset + smallLine
    settingGuis[23] = guiCreateLabel(20+xoffset, 30+yoffset, smallLine*spacing, smallLine, "Mostrar na lista telefonica:", false, settingGuis.main)
    guiSetFont(settingGuis[23], "default-small")
    settingGuis[24] = guiCreateButton(20+smallLine*spacing+xoffset, 30+yoffset, 190-smallLine*spacing, smallLine, (getPhoneSettings(phone, "isInPhonebook") == 1 and getPhoneSettings(phone, "isSecret") == 0) and "Ativado" or "Desativado", false, settingGuis.main)
	...
	-----------------------------------------------------
    yoffset = yoffset + 40
    settingGuis[6] = guiCreateLabel(10+xoffset, 10+yoffset, 200, 19, "Sons", false, settingGuis.main)
    ...
    settingGuis[10] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Toques:", false, settingGuis.main)
    ...
    yoffset = yoffset + smallLine
    settingGuis[11] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Toques SMS:", false, settingGuis.main)
    ...
    settingGuis[18] = guiCreateLabel(20+xoffset, 30+yoffset, smallLine*spacing, smallLine, "Tom de tecla:", false, settingGuis.main)
	...
	yoffset = yoffset
    settingGuis[33] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine+3, "Fundo do telefone:", false, settingGuis.main)
    ...
    settingGuis[31] = guiCreateLabel(20+xoffset, 30+yoffset, smallLine*spacing, smallLine, "Registro de chamadas e SMS:", false, settingGuis.main)
...
function guiSettingClick()
	...
	if source == settingGuis[22] then --hide caller id
		if guiGetText(settingGuis[22]) == "Desativado" then
			...
			guiSetText(settingGuis[22], "Ativado")

			guiSetEnabled(settingGuis[24], false)
			guiSetText(settingGuis[24], "Desativado")
		else
			setPhoneSettings(phone, "isSecret", 0)
			guiSetText(settingGuis[22], "Desativado")

			guiSetText(settingGuis[24], getPhoneSettings(phone, "isInPhonebook") == 1 and "Ativado" or "Desativado")
			guiSetEnabled(settingGuis[24], true)
	...
	elseif source == settingGuis[24] then --show on phonebook
		if guiGetText(settingGuis[24]) == "Desativado" then
			setPhoneSettings(phone, "isInPhonebook", 1)
			guiSetText(settingGuis[24], "Ativado")
...
function showConfirmBox(perkName, perkCost)
    GUIEditor.window[1] = guiCreateWindow(621, 364, 455, 104, "Recursos Premium", false)
    guiWindowSetSizable(GUIEditor.window[1], false)
    exports.global:centerWindow(GUIEditor.window[1])
    GUIEditor.label[1] = guiCreateLabel(11, 28, 429, 36, "Você está prestes a ativar \""..perkName.."\" vantagem que custa "..perkCost.." GC(s).\nVocê tem certeza que quer continuar?", false, GUIEditor.window[1])
    guiLabelSetHorizontalAlign(GUIEditor.label[1], "center", false)
    GUIEditor.button[1] = guiCreateButton(11, 64, 217, 30, "Sim!", false, GUIEditor.window[1])
    GUIEditor.button[2] = guiCreateButton(228, 64, 217, 30, "Não.", false, GUIEditor.window[1])  
