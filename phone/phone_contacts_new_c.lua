...
function guiNewContact(number)
	if isPhoneGUICreated() then
		...
		lName_contacts_new = guiCreateLabel(30,100,50,20, "Nome:", false, wPhoneMenu)
		fName_contacts_new = guiCreateEdit(30+50,100,150,20, "", false, wPhoneMenu)
		guiEditSetMaxLength(fName_contacts_new, 50)

		lNumber = guiCreateLabel(30,100+30,50,20, "Numero:", false, wPhoneMenu)
		...
		local bW, bH = 100, 35
		bAddContact = guiCreateButton(30,100+30*2,bW,bH, "Adicionar", false, wPhoneMenu)
		guiSetEnabled(bAddContact, false)
		bCancelContact = guiCreateButton(30+bW+2,100+30*2,bW,bH, "Cancelar", false, wPhoneMenu)
