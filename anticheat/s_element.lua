...
addEventHandler("onElementDataChange", getRootElement(),
	function (index, oldValue)
		...
		if getElementData(source, "char.Hunger") or getElementData(source, "char.Thirst") then
			return
		end
			...
			if (isProtected) then
				...
				if (sourceClient) then
					if (getElementType(sourceClient) == "player") then
						...
						local msg = "[AdmWarn] " .. getPlayerName(sourceClient) .. " enviou dados ilegais. "
						local msg2 = " (vitima: "..playername.." index: "..index .." newvalue:".. tostring(newData) .. " oldvalue:".. tostring(oldValue)  ..")"
						--outputConsole(msg)
						--outputConsole(msg2)
...
addEventHandler ( "onPlayerJoin", getRootElement(),
	function ()
		...
		protectElementData(source, "char.Hunger")
		protectElementData(source, "char.Thirst")
	end
);
