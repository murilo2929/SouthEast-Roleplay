...
function finalizePurchase(salesman, customer, carid, protection, premium, factionid)
	if isElement(customer) and carid and protection and premium and factionid then
		...
		if theVehicle then
			...
			outputChatBox("Você aceitou o plano de seguro. É válido a partir de agora. Para cancelar, entre em contato com a empresa.", customer)
			outputChatBox("O cliente aceitou o plano de seguro.", salesman) --sec didn't actually fix anything.
