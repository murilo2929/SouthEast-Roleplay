...
function showSettingsWindow(tab)
	...
	GUIEditor_Window.main = guiCreateWindow(x,y,w,h,"Definições",false)
	...
	GUIEditor_Tab.graphicSettings = guiCreateTab("Geral",GUIEditor_TabPanel.main)
	local lineH = 0.0515
	local posY = lineH

	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Configurações Gerais:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Ativar motion blur",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_skyclouds = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar nuvens",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.streams = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar streaming de audio",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_logs = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar log chatbox",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.cellphone_log = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar log de LIGAÇOES e SMS",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_chatbub = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar balão ao digitar",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_chatbub_square = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar quadrado ao digitar",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_typingicon = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar logos ao digitar",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat-system") then
	...
	GUIEditor_Checkbox.graphic_nametags = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar nametags",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.settings_hud_style = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar novo estilo HUD",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
	...
	GUIEditor_Checkbox.graphic_shaderradar = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar shader radar",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderwater = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar shader agua",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar shader veículo",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.vehicle_hotkey = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar teclas de controle veículo",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.autopark = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ativar veículo estacionar automatico (/park)",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName('vehicle') then
	...
	GUIEditor_Checkbox.vehicle_rims = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar modelos de roda personalizados",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.phone_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar animação celular",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.talk_anim = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar animação ao digitar",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.pm_username = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Mostrar seu /pm username.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.weapon_show_selector = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Mostrar seletor de arma ao atirar.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.bind_indicators = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar seta rebindavel.",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.dynamic_lighting = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar luzes dinamicas.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if groundsnow then
		posY = posY + lineH
		GUIEditor_Checkbox.groundsnow = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar neve no chão.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if snowfall then
		posY = posY + lineH
		GUIEditor_Checkbox.snowfall = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar neve.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if xmas then
		posY = posY + lineH
		GUIEditor_Checkbox.xmastreefx = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar arvore de natal FX.",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.punishment_notification_selector = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ocultar notificações de punição de administrador.",false,true,GUIEditor_Tab.graphicSettings)
	...
	if exports.integration:isPlayerSupporter(getLocalPlayer()) or exports.integration:isPlayerTrialAdmin(getLocalPlayer()) then
		posY = posY + lineH
		GUIEditor_Checkbox.auto_check = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Abrir automaticamente um report",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.enableNewUIStyle = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar novo estilo de GUI",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("hud") then
		if getElementData(localPlayer, "AtivarNewUIStyle") == "0" then
	...
	if exports.integration:isPlayerStaff(localPlayer) then
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar sons em reports recebidos",false,true,GUIEditor_Tab.graphicSettings)
		...
		posY = posY + lineH
		GUIEditor_Checkbox.enableIncomingPriorityReport = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Ativar sons em reports de prioridade recebidos",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.misc_sounds = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Desativar sons padrões do jogo",false,true,GUIEditor_Tab.graphicSettings)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.vehicle_discs = guiCreateCheckBox(0.0222+posX,posY,0.413,lineH,"Ocultar a descrição do veículo atual com ALTGR",false,true,GUIEditor_Tab.graphicSettings)
	...
	posX = posX + lineW2
	GUIEditor_Label.graphicSettings_desc = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Configurações de Overlay de descrição:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettings_desc,"default-bold-small")

	GUIEditor_Checkbox.enableOverlayDescription = guiCreateCheckBox(0.036+posX,0.1005,0.2992,lineH,"Alternar todas as descrições de overlay",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
		if getElementData(localPlayer, "AtivarOverlayDescription") == "0" then
	...
	GUIEditor_Checkbox.enableOverlayDescriptionVeh = guiCreateCheckBox(0.036+posX,0.1005+lineH,0.2992,lineH,"Vehicle: Ativar descrição",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
		if getElementData(localPlayer, "AtivarOverlayDescriptionVeh") == "0" then
	...
	GUIEditor_Checkbox.enableOverlayDescriptionPro = guiCreateCheckBox(0.036+posX,0.1005+lineH*3,0.2992,lineH,"Interior: Ativar descrição",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
		if getElementData(localPlayer, "AtivarOverlayDescriptionPro") == "0" then
	...
	GUIEditor_Checkbox.enableOverlayDescriptionNote = guiCreateCheckBox(0.036+posX,0.1005+lineH*5,0.2992,lineH,"Notas: Ativar descrição",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
		if getElementData(localPlayer, "AtivarOverlayDescriptionNote") == "0" then
	...
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Receba notificações sobre:",true,GUIEditor_Tab.Notifications)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.noti_faction_updates = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Atualizações de facção",false,true,GUIEditor_Tab.Notifications)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.noti_faction_updates,getElementData(localPlayer, "noti_faction_updates") ~= "0")

	GUIEditor_Checkbox.noti_offline_pm = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Mensagens offline",false,true,GUIEditor_Tab.Notifications)
	...
	local posX = lineW2
	posY = 0.1005
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Configurações Gerais:",true,GUIEditor_Tab.Notifications)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.noti_no_noti = guiCreateCheckBox(0.036+posX,0.1005,1,lineH,"Mostrar botão mesmo quando não houver notificações",false,true,GUIEditor_Tab.Notifications)
	...
	GUIEditor_Checkbox.social_classic_user_interface = guiCreateCheckBox(0.036,0.1005,0.888,lineH,"Interface de usuário clássica",false,true,GUIEditor_Tab.Social)
	...
	GUIEditor_Checkbox.social_invite_only = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Convite apenas (Ignorar todos os pedidos de amizade recebidos)",false,true,GUIEditor_Tab.Social)
	guiCheckBoxSetSelected(GUIEditor_Checkbox.social_invite_only,getElementData(localPlayer, "social_invite_only") == "1")

	posY = posY + lineH
	GUIEditor_Checkbox.social_friends_bypass_pmblock = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Permitir que meus amigos ignorem meu bloqueio de PM",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates = guiCreateCheckBox(0.036,0.1005+posY,0.888,lineH,"Receba alertas e notificações de amigos",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_msg = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Status mensagem",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_char = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Mudanças de personagem",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	GUIEditor_Checkbox.social_friend_updates_sound = guiCreateCheckBox(0.036+indent,0.1005+posY,0.888,lineH,"Ativar efeito sonoro",false,true,GUIEditor_Tab.Social)
	...
	posY = posY + lineH
	--[[
	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Ativar vehicle auto /park",false,true,GUIEditor_Tab.graphicSettings)
	if getElementData(localPlayer, "graphic_motionblur") == "0" then
		guiCheckBoxSetSelected(GUIEditor_Checkbox.graphic_motionblur,false)
	else
		guiCheckBoxSetSelected(GUIEditor_Checkbox.graphic_motionblur,true)
	...
	GUIEditor_Button.mainclose = guiCreateButton(0.0135,0.9135,0.9743,0.0675,"Fechar",true,GUIEditor_Window.main)
...
function applyGameSettings(name, value)
	if name and value then
		...
		elseif name == "AtivarNewUIStyle" then
