		...
		for key, value in ipairs( data.items ) do
			...
			if inBox and justClicked then
				...
				elseif not value.editable then
					...
					friends_message_window = guiCreateWindow( screen_x / 2 - 200, screen_y / 2 - 30, 400, 60, "Atualize sua mensagem de amigos", false )
			...
			if value.player then
				text = "jogando como " .. getPlayerName( value.player ):gsub( "_", " " ) .. " (" .. getElementData( value.player, "playerid" ) .. ")."
			else
			...
			if value.message then
				...
				dxDrawText( "Olá!", x + 10, y, w - 10, h, white, 1, small, "left", "top", true, true, true )
			end
...
local show = false
addCommandHandler( "friendsdawdasdawdwa",
	function( )
