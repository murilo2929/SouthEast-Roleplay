...
function newCharacter_create(characterName, characterDescription, race, gender, skin, height, weight, age, languageselected, month, day, location)
	...
	if (id) then --
		exports.logs:dbLog("ac"..tostring(accountID), 27, { "ac"..tostring(accountID), "ch" .. id } , "Criado" )
		...
		-- ID CARD
		exports.global:giveItem( client, 152, characterName..";"..(gender==0 and "Homem" or "Mulher")..";"..exports.global:numberToMonth(month).." "..exports.global:formatDate(day)..", "..year..";"..fingerprint)
		-- Briefcase
