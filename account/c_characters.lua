...
--[[
	...
	dxDrawText("Horas Jogadas:", 170+mta_posxOffset, 65+mta_posyOffset, 242, 106+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
	dxDrawText(getElementData(localPlayer, "account:hours") or 0, 265+mta_posxOffset, 65+mta_posyOffset, 311, 109+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default", "left", "top", false, false, true, false, false)
	...
	dxDrawText("Conta Criada em:", 8+mta_posxOffset, 88+mta_posyOffset, 137, 124+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
	dxDrawText(createdDate, 110+mta_posxOffset, 88+mta_posyOffset, 181, 125+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default", "left", "top", false, false, true, false, false)
	dxDrawText("Ultimo Login:", 8+mta_posxOffset, 106+mta_posyOffset, 74, 144+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
	dxDrawText(lastLoginDate or "Nunca", 85+mta_posxOffset, 106+mta_posyOffset, 171, 148+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default", "left", "top", false, false, true, false, false)
	dxDrawText("Email Registrado:", 8+mta_posxOffset, 125+mta_posyOffset, 113, 169+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, true, false, false)
    ...
    dxDrawText("Histórico da conta", 54+mta_posxOffset, 150+mta_posyOffset, width-54+mta_posxOffset, 183+mta_posyOffset, tocolor(255, 255, 255, 255), 1.00, "arial", "center", "top", false, false, true, false, false) -- History
    ...
    dxDrawText("Atualizar Personagens", 3+mta_posxOffset, 172+mta_posyOffset, buttonWidth+mta_posxOffset, 204+mta_posyOffset,  cooldown and cooldown>=getTickCount()-5000 and tocolor(255, 255, 255, 100) or tocolor(255, 255, 255, 255), 1.00, "arial", "center", "top", false, false, true, false, false)
...
function linkForumAccount()
	...
	forumLink.button[1] = guiCreateButton(165, 171, 143, 42, "Cancelar", false, forumLink.window[1])
	...
	forumLink.label[1] = guiCreateLabel(11, 23, 287, 17, "Southeast Roleplay Forum Login", false, forumLink.window[1])
	guiSetFont(forumLink.label[1], "default-bold-small")
	guiLabelSetHorizontalAlign(forumLink.label[1], "center", false)
	forumLink.label[2] = guiCreateLabel(12, 40, 287, 17, "Insira suas credenciais do fórum abaixo", false, forumLink.window[1])
	...
	forumLink.label[4] = guiCreateLabel(19, 118, 113, 15, "Senha:", false, forumLink.window[1])
...
function Characters_characterSelectionVisisble()
	...
	local text1= guiCreateLabel (0,0,1,1, "Desconectar", true, bLogout)
	...
	newCharacterButton_text = guiCreateLabel (0,0,1,1, "Criar novo personagem!", true, newCharacterButton)
	...
	addEventHandler("onClientGUIClick", newCharacterButton, function()
		if source == newCharacterButton or source == newCharacterButton_text then
			if guiGetText(newCharacterButton_text) ~= "Verificando a cota de personagens..." then
				guiSetText(newCharacterButton_text, "Verificando a cota de personagens...")
...
function characterMouseOver()
	...
	if isCursorShowing( ) then
		...
		if ped and isElement(ped) then
			...
			local text = "■ Etnia: "..tRace.."\n■ Gênero: "..(getElementData(ped, "account:charselect:gender") == 0 and "Homem" or "Mulher").."\n■ Status: "..(getElementData(ped, "account:charselect:cked") > 0 and "#FF0000Morto" or "#00FF00Vivo").."\n#FFFFFF■ Idade: "..getElementData(ped, "account:charselect:age").."\n■ Altura: "..getElementData(ped, "account:charselect:height").."cm\n■ Peso: "..getElementData(ped, "account:charselect:weight").."kg\n■ Jogado: "..getElementData(ped, "account:charselect:hoursplayed").."h"
			local text2 = "■ Etnia: "..tRace.."\n■ Gênero: "..(getElementData(ped, "account:charselect:gender") == 0 and "Homem" or "Mulher").."\n■ Status: "..(getElementData(ped, "account:charselect:cked") > 0 and "Morto" or "Vivo").."\n■ Idade: "..getElementData(ped, "account:charselect:age").."\n■ Altura: "..getElementData(ped, "account:charselect:height").."cm\n■ Peso: "..getElementData(ped, "account:charselect:weight").."kg\n■ Jogado: "..getElementData(ped, "account:charselect:hoursplayed").."h"
			...
			text = string.upper("Clique para jogar como "..name)
...
function characters_onSpawn(fixedName, adminLevel, gmLevel, location)
	...
	outputChatBox("Pressione F1 para obter ajuda.", 255, 194, 14)
	outputChatBox("Você pode visitar o menu Opções pressionando 'F10' ou /home.", 255, 194, 15)
	outputChatBox(" ")
	characters_destroyDetailScreen()
	...
	setTimer(function(expectedLocation)
		...
		if getDistanceBetweenPoints2D( currentPositionX, currentPositionY, unpack( defaultCharacterSelectionSpawnPosition ) ) < 20 and -- we are near angel pine
			...
			outputDebugString('Ficamos presos em um rio perto de Angel Pine, oooh~', 2)
