...
addEventHandler( "showCKList", getLocalPlayer(),
	function( names, data )
		if wCK then
			...
			local windowname = data == 2 and "Em memória de ..." or "Pessoa Desaparecida"
...
function showCKInfo(text, name)
	...
	ckInfoWindow = guiCreateWindow(ax, ay, 350, 200, name and ( "Corpo de (( " .. name .. " )) " ) or "Um cadáver.", false)
	...
	local cbutton = guiCreateButton(0.05, 0.85, 0.87, 0.1, "Fechar Menu", true, ckInfoWindow)
