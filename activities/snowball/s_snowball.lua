...
function makeSnowball(thePlayer)
	if not getElementData(thePlayer, "snowball") then
		...
		setTimer(function()
			...
			triggerEvent('sendAme', thePlayer, "pega neve do chão e forma uma bola de neve.")
				...
				if isElement(thePlayer) then 
					if getElementData(thePlayer, "snowball") then
						if getElementData(thePlayer, "snowball") == obj then
							triggerEvent('sendAme', thePlayer, "'s bola de neve derreteu de suas mãos.")
	...
	if getElementData(thePlayer, "snowball") then
		...
		setTimer(function()
			...
			setTimer(function()
				...
				destroyElement(obj)
				if hitElement then
					triggerEvent('sendAme', hitElement, "é atingido por uma bola de neve.")
