...
function search_error ( )
	...
	window.window = guiCreateWindow( x, y, width, height, "MDC Falha na Pesquisa", false )
	
	window.errorLabel = guiCreateLabel( 10, 30, width - 20, 20, "Você precisa selecionar um tipo de pesquisa!", false, window.window )
