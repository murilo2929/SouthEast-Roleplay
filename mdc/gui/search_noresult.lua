...
function search_noresult ( )
	...
	window.window = guiCreateWindow( x, y, width, height, "MDC Pesquisa - Sem Resultados!", false )
	
	window.errorLabel = guiCreateLabel( 10, 30, width - 20, 20, "Não conseguimos encontrar nenhuma correspondência para isso!", false, window.window )
