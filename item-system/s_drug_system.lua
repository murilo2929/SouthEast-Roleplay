function mixDrugs(drug1, drug2, drug1name, drug2name)
	...
	if (given) then
		outputChatBox("Você misturou '" .. drug1name .. "' e '" .. drug2name .. "' para formar '" .. drugName .. "'", client)
		exports.global:sendLocalMeAction(client, "mistura alguns produtos químicos juntos.")
	else
		outputChatBox("Você não tem espaço suficiente para misturar esses produtos químicos.", client, 255, 0, 0)
