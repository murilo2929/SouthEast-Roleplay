...
function processCustomInterior(player, command, dimension, playerUsername, userId)
    ...
    exports.global:sendMessageToAdmins("[UCP] Player "..playerUsername.." carregou um interior personalizado para a propriedade ID#"..dimension..".")
	...
	loadDimension(tonumber(dimension), function (objectCount)
        ...
        exports.global:sendMessageToAdmins("[UCP] Carregado "..objectCount.." objetos personalizados de interior para propriedade ID#"..dimension)
	end)
end
...
addCommandHandler("reloadinterior", function (player, command, dimension)
	...
	if not dimension then
		outputChatBox("Syntax: /" .. command .. " [dimension] - Recarrega todos os objetos personalizados enviados para o interior.", player, 255, 255, 255)
	end

	loadDimension(dimension, function (objectCount)
		outputChatBox("Você recriou com sucesso o " .. objectCount .. " objetos em dimensão " .. dimension .. ".", player, 100, 255, 100)
	end)
end, false, false)