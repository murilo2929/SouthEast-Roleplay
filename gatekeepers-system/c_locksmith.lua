...
function createGUI()
	...
	GUIEditor.window[1] = guiCreateWindow(656, 279, 272, 180, "Duplicador de Chave", false)
	guiWindowSetSizable(GUIEditor.window[1], false)

	GUIEditor.label[1] = guiCreateLabel(0.03, 0.12, 0.93, 0.09, "Olá! O que você gostaria de copiar hoje?", true, GUIEditor.window[1])
	GUIEditor.combobox[1] = guiCreateComboBox(0.03, 0.27, 0.47, 0.69, "", true, GUIEditor.window[1])
	guiComboBoxAddItem(GUIEditor.combobox[1], "Chave de Casa")
	guiComboBoxAddItem(GUIEditor.combobox[1], "Chave de Negócio")
	guiComboBoxAddItem(GUIEditor.combobox[1], "Chave de Veículo")
	guiComboBoxAddItem(GUIEditor.combobox[1], "Controle Remoto Garagem")
	guiComboBoxAddItem(GUIEditor.combobox[1], "Controle Remoto Elevador")

	GUIEditor.edit[1] = guiCreateEdit(0.52, 0.41, 0.43, 0.13, "Chave ID", true, GUIEditor.window[1])
	GUIEditor.label[2] = guiCreateLabel(0.53, 0.29, 0.40, 0.12, "Chave ID", true, GUIEditor.window[1])
	GUIEditor.label[3] = guiCreateProgressBar(0.53, 0.60, 0.42, 0.10, true, GUIEditor.window[1])
	GUIEditor.button[1] = guiCreateButton(0.53, 0.75, 0.23, 0.18, "Duplicar", true, GUIEditor.window[1])
	...
	GUIEditor.button[2] = guiCreateButton(0.76, 0.75, 0.19, 0.18, "Fechar", true, GUIEditor.window[1])
