		...
		for i = 1, #newTombs do
			...
			if getDistanceBetweenPoints3D(cx,cy,cz,x,y,z) <= viewDistance then --Within radius viewDistance
				...
				if px and isLineOfSightClear(cx, cy, cz, x, y, z, true, false, false, true, true, false, false) then	
					...
					local textToDraw = string.gsub(tombInfo.charactername or "Desconhecido", "_", " ")
					local textToDraw2 = "○ "..(tombInfo.born or "Desconhecido").." ○"
					local textToDraw3 = "○ "..(tombInfo.dead or "Desconhecido").." ○"
					local textToDraw4 = string.upper(tombInfo.tomb_text and ("'"..tombInfo.tomb_text.."'") or "'Descanse em paz'")
