...
function build_Dialog()
	...
	gui["_root"] = guiCreateWindow(left, top, windowWidth, windowHeight, "Equipe NPC 911 chamada", false)
	guiWindowSetSizable(gui["_root"], false)
	
	gui["lineEdit"] = guiCreateEdit(20, 165, 171, 31, "", false, gui["_root"])
	guiEditSetMaxLength(gui["lineEdit"], 32767)
	
	gui["pushButton"] = guiCreateButton(250, 145, 75, 23, "Enviar", false, gui["_root"])
	addEventHandler("onClientGUIClick", gui["pushButton"], function()
			...
			outputChatBox("Uma chamada NPC 911 foi feita.")
		end, false)
	
	gui["pushButton_2"] = guiCreateButton(250, 185, 75, 23, "Fechar", false, gui["_root"])
	...
	gui["label"] = guiCreateLabel(20, 145, 111, 16, "Local", false, gui["_root"])
	guiLabelSetHorizontalAlign(gui["label"], "left", false)
	guiLabelSetVerticalAlign(gui["label"], "center")
	
	gui["label_2"] = guiCreateLabel(20, 25, 121, 16, "Situação", false, gui["_root"])
