local outboundPhoneNumber = "Oculto Não."
...
function doTheCall(thePlayer, location, message)
	...
	for key, value in ipairs( affectedElements ) do
		...
		outputChatBox("[RADIO] Aqui é a central, recebemos uma chamada de incidente de #" .. outboundPhoneNumber .. ", cambio.", value, 0, 183, 239)
		outputChatBox("[RADIO] Situação: '" .. message .. "', over.", value, 0, 183, 239)
		outputChatBox("[RADIO] Local: '" .. tostring(location) .. "', out.", value, 0, 183, 239)
	end
end
