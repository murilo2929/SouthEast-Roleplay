	...
	dbQuery(function(qh, userid, staffTitles, target, userid, ranks, details, thePlayer)
		...
		if result then
			...
			if ranks[1] and ranks[1] ~= tonumber(user.admin) then
				...
				exports.global:sendMessageToStaff("[STAFF UPDATE] "..exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[1] > tonumber(user.admin) and "promoveu" or "rebaixou").." '"..user.username.."' de "..staffTitles[1][tonumber(user.admin)].." para "..staffTitles[1][ranks[1]]..".", true)
				exports.announcement:makePlayerNotification(target or user.id, "Staff Rank Updated", exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[1] > tonumber(user.admin) and "promoveu" or "rebaixou").." você de "..staffTitles[1][tonumber(user.admin)].." para "..staffTitles[1][ranks[1]]..". \n" .. (ranks[1] > tonumber(user.admin) and "Congratulations!" or "Sorry!"))
			...
			if ranks[2] and ranks[2] ~= tonumber(user.supporter) then
				...
				exports.global:sendMessageToStaff("[STAFF UPDATE] "..exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[2] > tonumber(user.supporter) and "promoveu" or "rebaixou").." '"..user.username.."' de "..staffTitles[2][tonumber(user.supporter)].." para "..staffTitles[2][ranks[2]]..".", true)
				exports.announcement:makePlayerNotification(target or user.id, "Staff Rank Updated", exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[2] > tonumber(user.supporter) and "promoveu" or "rebaixou").." você de "..staffTitles[2][tonumber(user.supporter)].." para "..staffTitles[2][ranks[2]]..". \n" .. (ranks[2] > tonumber(user.supporter) and "Congratulations!" or "Sorry!"))
			...
			if ranks[3] and ranks[3] ~= tonumber(user.vct) then
				...
				exports.global:sendMessageToStaff("[STAFF UPDATE] "..exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[3] > tonumber(user.vct) and "promoveu" or "rebaixou").." '"..user.username.."' de "..staffTitles[3][tonumber(user.vct)].." para "..staffTitles[3][ranks[3]]..".", true)
				exports.announcement:makePlayerNotification(target or user.id, "Staff Rank Updated", exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[3] > tonumber(user.vct) and "promoveu" or "rebaixou").." você de "..staffTitles[3][tonumber(user.vct)].." para "..staffTitles[3][ranks[3]]..". \n" .. (ranks[3] > tonumber(user.vct) and "Congratulations!" or "Sorry!"))
			...
			if ranks[4] and ranks[4] ~= tonumber(user.scripter) then
				...
				exports.global:sendMessageToStaff("[STAFF UPDATE] "..exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[4] > tonumber(user.scripter) and "promoveu" or "rebaixou").." '"..user.username.."' de "..staffTitles[4][tonumber(user.scripter)].." para "..staffTitles[4][ranks[4]]..".", true)
				exports.announcement:makePlayerNotification(target or user.id, "Staff Rank Updated", exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[4] > tonumber(user.scripter) and "promoveu" or "rebaixou").." você de "..staffTitles[4][tonumber(user.scripter)].." para "..staffTitles[4][ranks[4]]..". \n" .. (ranks[4] > tonumber(user.scripter) and "Congratulations!" or "Sorry!"))
			...
			if ranks[5] and ranks[5] ~= tonumber(user.mapper) then
				...
				exports.global:sendMessageToStaff("[STAFF UPDATE] "..exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[5] > tonumber(user.mapper) and "promoveu" or "rebaixou").." '"..user.username.."' de "..staffTitles[5][tonumber(user.mapper)].." para "..staffTitles[5][ranks[5]]..".", true)
				exports.announcement:makePlayerNotification(target or user.id, "Staff Rank Updated", exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[5] > tonumber(user.mapper) and "promoveu" or "rebaixou").." você de "..staffTitles[5][tonumber(user.mapper)].." para "..staffTitles[5][ranks[5]]..". \n" .. (ranks[5] > tonumber(user.mapper) and "Congratulations!" or "Sorry!"))
			...
			if ranks[6] and ranks[6] ~= tonumber(user.fmt) then
				...
				exports.global:sendMessageToStaff("[STAFF UPDATE] "..exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[6] > tonumber(user.fmt) and "promoveu" or "rebaixou").." '"..user.username.."' de "..staffTitles[6][tonumber(user.fmt)].." para "..staffTitles[6][ranks[6]]..".", true)
				exports.announcement:makePlayerNotification(target or user.id, exports.global:getPlayerFullIdentity(thePlayer, 1, true).." "..(ranks[6] > tonumber(user.fmt) and "promoveu" or "rebaixou").." você de "..staffTitles[6][tonumber(user.fmt)].." para "..staffTitles[6][ranks[6]]..".", (ranks[6] > tonumber(user.fmt) and "Congratulations!" or "Sorry!"))
			...
			triggerEvent("staff:getStaffInfo", thePlayer, user.username, "Staff rank para "..user.username.." foi definido!")
		end
...
function makePlayerStaff(thePlayer, commandName, who, rank) --/ MAXIME
	if exports.integration:isPlayerSeniorAdmin(thePlayer) or exports.integration:isPlayerVehicleConsultant(thePlayer) or exports.integration:isPlayerLeadScripter(thePlayer) or exports.integration:isPlayerMappingTeamLeader(thePlayer) then
		if not (who) or not (tonumber(rank)) then
			outputChatBox("SYNTAX: /" .. commandName .. " [Nome Parcial Jogador/ID] [Staff Team ID] [Rank]", thePlayer, 255, 194, 14)
			outputChatBox("SYNTAX: /" .. commandName .. " [Usuario Exato] [Rank, -1 .. -4 = GMs, 1 .. 7 = Admins]", thePlayer, 255, 194, 14)
		else
			...
			if (rank < 0) then
				local gmrank = -rank
				outputChatBox("Você definiu o rank (GM) de " .. targetPlayerName .. " para " .. tostring(gmrank) .. ".", thePlayer, 0, 255, 0)
				--outputChatBox(adminTitle .. " " .. username .. " set your GM rank para " .. gmrank .. ".", targetPlayer, 255, 194, 14)
			...
			elseif rank == 0 then
				...
				outputChatBox("Você definiu o rank de " .. targetPlayerName .. " para Player.", thePlayer, 0, 255, 0)
				exports.anticheat:changeProtectedElementDataEx(targetPlayer, "admin_level", 0, false)
				exports.anticheat:changeProtectedElementDataEx(targetPlayer, "duty_admin", 0, true)
				...
				--outputChatBox(adminTitle .. " " .. username .. " set your admin rank para " .. rank .. ".", targetPlayer, 255, 194, 14)
				outputChatBox("Você definiu o rank de " .. targetPlayerName .. "para Admin " .. tostring(rank) .. ".", thePlayer, 0, 255, 0)
