...
local function updateGUI()
	if show then
		...
		if exports.integration:isPlayerSupporter(localPlayer) or exports.integration:isPlayerTrialAdmin(localPlayer) then
			textString = getAdminTitle( localPlayer ) .. " :: " .. onduty .. admstr .. ( (getElementData( localPlayer, "admin_level" ) <= 10 )and ( " :: " .. ( openReports - handledReports ) .. " relatório sem respostas" .. reporttext .. " :: " .. handledReports .. " relatórios tratados" .. ownreporttext .. " :: " .. ckAmount .. " solicitações CK não respondidas ::") or "" )
		else
			textString = getAdminTitle( localPlayer ) .. " :: " .. ( openReports - handledReports ) .. " relatórios não respondidos" .. reporttext .. " :: " .. handledReports .. " relatórios tratados" .. ownreporttext .. " :: "
		end
	end
end
