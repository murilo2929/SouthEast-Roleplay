...
function showGUI()
	...
	helpLabel = guiCreateLabel(x, y, width, height, "Clique com o botão esquerdo para definir o alvo do GPS - Clique com o botão direito para desativar o GPS", false)
