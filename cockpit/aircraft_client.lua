...
function renderAircraftFX()
 if isPedInVehicle(getLocalPlayer()) then
	...
	dxDrawText ( " no chão", width/2 + 675 * rel/2, height - 45 * rel, nil, nil, tocolor(150, 150, 150), 1 * rel, "default", "left", "top")
	...
	dxDrawText ( " trancado", width/2 + 675 * rel/2, height - 70 * rel, nil, nil, tocolor(150, 150, 150), 1 * rel, "default", "left", "top")
	...
	dxDrawText ( " Engrenagem", width/2 - 750 * rel/2, height - 45 * rel, nil, nil, tocolor(150, 150, 150), 1 * rel, "default", "left", "top")
	...
	dxDrawText ( " Motor", width/2 - 750 * rel/2, height - 70 * rel, nil, nil, tocolor(150, 150, 150), 1 * rel, "default", "left", "top")
	--=============attitude indicator==============--
