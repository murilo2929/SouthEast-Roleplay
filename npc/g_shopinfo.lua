...
g_shops = {
	...
	{ -- 20
		name = "Teste",
		description = "Loja Acessórios!",
		image = "general.png",
		
		{
			name  = "Mascaras",
			{ name = "Kar Maskesi", description = "Siyah kalın bir kar maskesi.", price = 12, itemID = 56 },
			{ name = "Domuz Maskesi", description = "Domuz kafası maskesi.", price = 20, itemID = 223 },
			{ name = "Canavar Maskesi", description = "Şeytan kafası maskesi!", price = 30, itemID = 224 },
			{ name = "Mascara Hockey", description = "Warner Bros. 'Jason' karakteri maskesi.", price = 35, itemID = 277 },
			{ name = "Maymun Maskesi", description = "Maymun kafası maskesi.", price = 20, itemID = 226 },
