...
addEventHandler('item:move', root,
  function(object)
    ...
    if editing and object then
      ...
      bProtect = guiCreateButton( 5, 200, 65, 20, 'Proteger', false, wInfo )
      ...
      bReset = guiCreateButton( 75, 200, 65, 20, 'Resetar', false, wInfo )
      ...
      bSave = guiCreateButton( 145, 200, 65, 20, 'Salvar', false, wInfo )
      ...
      bClose = guiCreateButton( 215, 200, 30, 20, 'Fechar', false, wInfo )
      ...
      local controls = guiCreateLabel( 15, 225, 240, 40, "Mover: WASDF, Arrow Up/Down\nRotacionar: Arrow Left/Right", false, wInfo )
