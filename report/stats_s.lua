...
function updateStaffReportCount( thePlayer, report )
	...
	if adminreports_saved >= reportsToAward then
		...
		exports.achievement:awardPlayer(thePlayer, false, "Cuidou de "..reportsToAward.." reporte(s)!", gcToAward)
		exports.global:sendWrnToStaff(exports.global:getPlayerFullIdentity(thePlayer).." ganhou "..gcToAward.." GCs por completar "..reportsToAward.." reportes.", "ACHIEVEMENT")
	else
