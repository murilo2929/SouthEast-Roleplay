--MAXIME
local guiStep3 = {}
local info = "Sua aplicação está sendo analisada..\nPor favor espere!"
function startStep3(infoFromServer)
	...
	guiStep3.back = guiCreateButton ( 0.40, 0.81, 0.1, 0.04, "Regras do servidor", true)
	guiStep3.retake = guiCreateButton ( 0.5, 0.81, 0.1, 0.04, "Fazer nova aplicação", true)
