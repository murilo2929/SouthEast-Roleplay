...
function openAppsWindow(apps1, quests1)
	...
	if gui1.main and isElement(gui1.main) then
		guiSetText(gui1.main, "Southeast Roleplay Gerente de Aplicações")
		guiSetEnabled(gui1.main, true)
	else
		triggerEvent( 'hud:blur', resourceRoot, 6, false, 0.5, nil )
		local w, h = 740,474
		local x, y = (screenWidth-w)/2, (screenHeight-h)/2
		gui1.main = guiCreateWindow(x,y,w,h,"Southeast Roleplay Gerente de Aplicações | CARREGANDO..",false)
		guiWindowSetSizable(gui1.main, false)

		gui1.tabPanel = guiCreateTabPanel(0.0122,0.0401,0.9757,0.87,true,gui1.main)

		gui1.tab_pendingApps = guiCreateTab("Pendente",gui1.tabPanel)
		gui1.grid_pendingApps = guiCreateGridList(0,0,1,1,true,gui1.tab_pendingApps)
		gui1.grid_pendingApps_col_id = guiGridListAddColumn(gui1.grid_pendingApps,"Aplicação ID",0.1)
		gui1.grid_pendingApps_col_applicant = guiGridListAddColumn(gui1.grid_pendingApps,"Nome do Aplicante",0.2)
		gui1.grid_pendingApps_col_postDate = guiGridListAddColumn(gui1.grid_pendingApps,"Data de Envio",0.2)
		gui1.grid_pendingApps_col_reviewer = guiGridListAddColumn(gui1.grid_pendingApps,"Revisor",0.2)
		gui1.grid_pendingApps_col_reviewedDate = guiGridListAddColumn(gui1.grid_pendingApps,"Data da Revisão",0.2)

		gui1.tab_acceptedApps = guiCreateTab("Aceito",gui1.tabPanel)
		gui1.grid_acceptedApps = guiCreateGridList(0,0,1,1,true,gui1.tab_acceptedApps)
		gui1.grid_acceptedApps_col_id = guiGridListAddColumn(gui1.grid_acceptedApps,"Aplicação ID",0.1)
		gui1.grid_acceptedApps_col_applicant = guiGridListAddColumn(gui1.grid_acceptedApps,"Nome do Aplicante",0.2)
		gui1.grid_acceptedApps_col_postDate = guiGridListAddColumn(gui1.grid_acceptedApps,"Data de Envio",0.2)
		gui1.grid_acceptedApps_col_reviewer = guiGridListAddColumn(gui1.grid_acceptedApps,"Revisor",0.2)
		gui1.grid_acceptedApps_col_reviewedDate = guiGridListAddColumn(gui1.grid_acceptedApps,"Data da Revisão",0.2)

		gui1.tab_deniedApps = guiCreateTab("Recusado",gui1.tabPanel)
		gui1.grid_deniedApps = guiCreateGridList(0,0,1,1,true,gui1.tab_deniedApps)
		gui1.grid_deniedApps_col_id = guiGridListAddColumn(gui1.grid_deniedApps,"Aplicação ID",0.1)
		gui1.grid_deniedApps_col_applicant = guiGridListAddColumn(gui1.grid_deniedApps,"Nome do Aplicante",0.2)
		gui1.grid_deniedApps_col_postDate = guiGridListAddColumn(gui1.grid_deniedApps,"Data de Envio",0.2)
		gui1.grid_deniedApps_col_reviewer = guiGridListAddColumn(gui1.grid_deniedApps,"Revisor",0.2)
		gui1.grid_deniedApps_col_reviewedDate = guiGridListAddColumn(gui1.grid_deniedApps,"Data da Revisão",0.2)

		gui1.tab_appPart1 = guiCreateTab("Aplicação - Part 1",gui1.tabPanel)
		...
		gui1.grid_appPart1_col_question = guiGridListAddColumn(gui1.grid_appPart1,"Pergunta",0.36)
		gui1.grid_appPart1_col_updatedBy = guiGridListAddColumn(gui1.grid_appPart1,"Atualizado por",0.1)
		gui1.grid_appPart1_col_updateDate = guiGridListAddColumn(gui1.grid_appPart1,"Data de Atualização",0.18)
		gui1.grid_appPart1_col_createdBy = guiGridListAddColumn(gui1.grid_appPart1,"Criado por",0.1)
		gui1.grid_appPart1_col_createDate = guiGridListAddColumn(gui1.grid_appPart1,"Data da Criação",0.18)

		gui1.tab_appPart2 = guiCreateTab("Aplicação - Part 2",gui1.tabPanel)
		...
		gui1.grid_appPart2_col_question = guiGridListAddColumn(gui1.grid_appPart2,"Pergunta",0.36)
		gui1.grid_appPart2_col_updatedBy = guiGridListAddColumn(gui1.grid_appPart2,"Atualizado por",0.1)
		gui1.grid_appPart2_col_updateDate = guiGridListAddColumn(gui1.grid_appPart2,"Data de Atualização",0.18)
		gui1.grid_appPart2_col_createdBy = guiGridListAddColumn(gui1.grid_appPart2,"Criado por",0.1)
		gui1.grid_appPart2_col_createDate = guiGridListAddColumn(gui1.grid_appPart2,"Data da Criação",0.18)

		gui1.refresh = guiCreateButton(0.0135,0.9135,0.48715,0.0675,"Atualizar",true,gui1.main)

		gui1.part1CreateNew = guiCreateButton(0.0135,0.9135,0.48715,0.0675,"Criar Nova Pergunta",true,gui1.main)
		guiSetVisible(gui1.part1CreateNew, false)
		gui1.part2CreateNew = guiCreateButton(0.0135,0.9135,0.48715,0.0675,"Criar Nova Pergunta",true,gui1.main)
		guiSetVisible(gui1.part2CreateNew, false)

		gui1.bClose = guiCreateButton(0.0135+0.48715,0.9135,0.48715,0.0675,"Fechar",true,gui1.main)
...
function updateApps()
	...
	for i = 1, #apps do
		if apps[i]["state"] == "0" then
			...
			guiGridListSetItemText(gui1.grid_pendingApps, row, gui1.grid_pendingApps_col_reviewer,( apps[i]["Reviewer"] or "Ninguem" ), false, false)
			guiGridListSetItemText(gui1.grid_pendingApps, row, gui1.grid_pendingApps_col_reviewedDate,( apps[i]["datereviewed"] or "Nunca" ), false, false)
		elseif apps[i]["state"] == "1" then
			...
			guiGridListSetItemText(gui1.grid_acceptedApps, row, gui1.grid_acceptedApps_col_reviewer,( apps[i]["Reviewer"] or "Ninguem" ), false, false)
			guiGridListSetItemText(gui1.grid_acceptedApps, row, gui1.grid_acceptedApps_col_reviewedDate,( apps[i]["datereviewed"] or "Nunca" ), false, false)
		elseif apps[i]["state"] == "2" then
			...
			guiGridListSetItemText(gui1.grid_deniedApps, row, gui1.grid_deniedApps_col_reviewer, ( apps[i]["Reviewer"] or "Ninguem" ), false, false) --
			guiGridListSetItemText(gui1.grid_deniedApps, row, gui1.grid_deniedApps_col_reviewedDate,( apps[i]["datereviewed"] or "Nunca" ), false, false)
		end
	end
...
function openAppDetail(appData, readOnly)
	...
	if appData then
		...
		local w, h = 740,515
		local x, y = (screenWidth-w)/2, (screenHeight-h)/2
		gui3.main = guiCreateWindow(x,y,w,h,"Análise "..appData.username.."'s Aplicação ID#"..appData.id,false)
		...
		--Meta data
		gui3.meta1 = guiCreateLabel(margin, margin+20+yOffset+panelH*2, panelW, line, "Nome do candidato: "..(appData.username or "-"), false, gui3.main )
		...
		gui3.text = guiCreateLabel(margin+panelW+margin, margin+20+yOffset+panelH*2, panelW, line, "Data de envio: "..(appData.dateposted or "-"), false, gui3.main )
		guiSetFont(gui3.text, "default-bold-small")
		gui3.text = guiCreateLabel(margin+panelW+margin, margin+20+line+yOffset+panelH*2, panelW, line, "Data da Revisão: "..(appData.datereviewed or "Nunca"), false, gui3.main )
		guiSetFont(gui3.text, "default-bold-small")
		gui3.text = guiCreateLabel(margin+panelW+margin, margin+20+line*2+yOffset+panelH*2, panelW, line, "Revisor: "..(appData.reviewer or "Ninguem"), false, gui3.main )
		guiSetFont(gui3.text, "default-bold-small")
		gui3.text = guiCreateLabel(margin, margin+20+line*2+yOffset+panelH*2, panelW, line, "Nota (Razão para aceitar/recusar):", false, gui3.main)
		guiSetFont(gui3.text, "default-bold-small")
		...
		gui3.bAccept = guiCreateButton(margin,margin+25+line*7+yOffset+panelH*2,buttonW,30,"Aceitar",false,gui3.main)
		...
		gui3.bDecline = guiCreateButton(margin+buttonW,margin+25+line*7+yOffset+panelH*2,buttonW,30,"Recusar",false,gui3.main)
		...
		gui3.bClose = guiCreateButton(margin+buttonW*2,margin+25+line*7+yOffset+panelH*2,buttonW,30,"Fechar",false,gui3.main)
...
function openConfirmBox(id, applicant, username, num, text34 )
	...
	GUIEditor_Label[8] = guiCreateLabel(0.0254,0.2072,0.9645,0.1982,"Você está prestes a "..(num == 1 and "ACEITAR" or "RECUSAR").." "..username.."'s e sua aplicação.",true,GUIEditor_Window[3])
...
function openQuestionDetail(part1, createNew, fromServer, data)
	...
	if gui2.main and isElement(gui2.main) then
		...
		local loadingText = "Recuperando dados do servidor. Por favor, espere.."
		if createNew then
			loadingText = ""
		end
		...
		gui2.lQuestion = guiCreateLabel(20, 25, windowWidth-40, line, "Pergunta:", false, gui2.main)
		...
		if part == 1 then
			gui2.rAns1 = guiCreateRadioButton(20, 30+line*4, windowWidth-40, line, "Escolha 1:", false, gui2.main)
			...
			gui2.rAns2 = guiCreateRadioButton(20, 30+line*7, windowWidth-40, line, "Escolha 2:", false, gui2.main)
			gui2.eAns2 = guiCreateEdit(20, 30+line*8, windowWidth-40, line*2, loadingText, false, gui2.main)
			guiEditSetMaxLength(gui2.eAns2, 65)

			gui2.rAns3 = guiCreateRadioButton(20, 30+line*10, windowWidth-40, line, "Escolha 3:", false, gui2.main)
		...
		gui2["confirm"] = guiCreateButton(20, 130+length, windowWidth/3-20, 40, "Salvar", false, gui2.main)
		...
		gui2["delete"] = guiCreateButton(windowWidth/3, 130+length, windowWidth/3, 40, "Deletar", false, gui2.main)
		...
		gui2["btnCancel"] = guiCreateButton((windowWidth/3)*2, 130+length, windowWidth/3-20, 40, "Cancelar", false, gui2.main)
