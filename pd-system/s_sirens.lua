...
function setSirenState(type)
    if exports.global:hasItem(source, 85) or exports.global:hasItem(source, 261) or exports.global:hasItem(source, 269) or ( getVehicleName( source ) == 'Police LV' ) or ( getVehicleName( source ) == 'Police SF' ) or ( getVehicleName( source ) == 'FBI rancher' ) or ( getVehicleName( source ) == 'Police LS' ) or ( getVehicleName( source ) == 'Police Ranger' ) then -- sirens
    	if type == "horn" then
