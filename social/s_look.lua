			...
			if key == "weight" or key == "height" then
				if exports.mysql:query_free("UPDATE characters SET " .. exports.mysql:escape_string( key ) .. " = '" .. exports.mysql:escape_string( value ) .. "' WHERE id = " .. exports.mysql:escape_string( getElementData( client, "dbid" ) ) ) then
					...
					if admin then
						...
						outputChatBox( "Você definiu " .. targetPlayerName .. "'s " .. stuff.name .. " para " .. value .. ".", admin, 0, 255, 0 )
						...
						if (hiddenAdmin==0) then
							outputChatBox(tostring(adminTitle) .. " " .. getPlayerName(admin) .. " definiu seu " .. stuff.name .. " para " .. value .. ".", client, 0, 255, 0)
						else
							outputChatBox("A Hidden Admin definiu seu " .. stuff.name .. " para " .. value .. ".", client, 0, 255, 0)
						end
					else
						if not value or value == "" then value = "none" end
						outputChatBox( "definiu seu " .. stuff.name .. " para " .. value .. ".", client, 0, 255, 0 )
					end
				else
