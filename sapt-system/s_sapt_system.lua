	...
	if seat == 0 then
		...
		if (getElementData(source, "faction") == 64) and (vehicleModel == 431 or vehicleModel == 437) then
			if (exports.global:takeMoney(thePlayer, 10)) then
				...
				exports.hud:sendBottomNotification(thePlayer, "SAPT Bus Notification", "Você foi cobrado $10 para usar nossos serviços.")
			else
				local x, y, z = getElementPosition(thePlayer)
				removePedFromVehicle(thePlayer)
				setElementPosition(thePlayer, x, y, z+1)
				exports.hud:sendBottomNotification(thePlayer, "SAPT Bus Notification", "Você precisa de $10 para usar nossos serviços, desculpe!")
			end
		end
	end
end
...
function announceStop(thisStop, nextStop)
	if (nextStop == "") then
		exports.global:sendLocalText(client, "|| SAPT Anúncio - Parada atual: " .. thisStop .. " ||", 0, 0, 191)
		exports.global:sendLocalText(client, "|| SAPT Anúncio - Fim da linha ||", 0, 0, 191)
	elseif (thisStop == "") then
		exports.global:sendLocalText(client, "|| SAPT Anúncio - Inicio da linha ||", 0, 0, 191)
		exports.global:sendLocalText(client, "|| SAPT Anúncio - Primeira parada: " .. nextStop .. " ||", 0, 0, 191)
	else
		exports.global:sendLocalText(client, "|| SAPT Anúncio - Parada atual: " .. thisStop .. " ||", 0, 0, 191)
		exports.global:sendLocalText(client, "|| SAPT Anúncio - Proxima parada: " .. nextStop .. " ||", 0, 0, 191)
	end
end
