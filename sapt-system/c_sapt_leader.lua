...
function showIBISAdmin(cRoutes, cLines, cDestinations)
	...
	ibisAdmin.tab = { }
	ibisAdmin.tab[1] = guiCreateTab("Rotas", ibisAdmin.tabPanel)
	ibisAdmin.tab[2] = guiCreateTab("Destinos", ibisAdmin.tabPanel)
	ibisAdmin.tab[3] = guiCreateTab("Paradas", ibisAdmin.tabPanel)
end
