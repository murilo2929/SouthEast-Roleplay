...
function setElementDataEx(theElement, theParameter, thValue, syncToClient, noSyncAtall)
...
drinktable = trueCheck { 9, 15, 58, 62, 63, 83, 91, 95, 101, 132, 179, 180 }
foodtable = trueCheck { 1, 8, 11, 12, 13, 14, 42, 59, 89, 92, 93, 99, 102, 108, 213}
