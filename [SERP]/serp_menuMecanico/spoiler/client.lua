...
addEventHandler("spoiler:gui", root,
	function()
		...
		close = guiCreateButton(10, 306, 590, 33, "Fechar", false, spoilerGUI)
	end
)
		...
		if (b == "left") then
			...
			elseif (source == saves) then
				...
				if selectedIndex ~= -1 then
					...
					if not veh then
						outputChatBox("[-]#f9f9f9 Aproxime-se do porta-malas do veículo em que deseja instalar um spoiler.." ,98, 149, 245,true)
					return end
					...
					outputChatBox("[-]#f9f9f9 você tem que fazer uma escolha.", 230, 30, 30, true)
				end
