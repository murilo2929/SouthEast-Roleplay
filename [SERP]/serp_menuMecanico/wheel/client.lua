...
addEventHandler("jant:gui", root,
	function()
		...
		close = guiCreateButton(10, 306, 590, 33, "Fechar", false, mechanicGUI)
	end
)
		...
		if (b == "left") then
			...
			elseif (source == save) then
				...
				if selectedIndex ~= -1 then
					...
					if not veh then
						outputChatBox("[-]#f9f9f9 Aproxime-se do pneu do veículo que você deseja instalar." ,98, 149, 245,true)
					return end
