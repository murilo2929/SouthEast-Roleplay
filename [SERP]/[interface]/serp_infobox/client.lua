...
function getColors(render)
    ...
    if enabled then
        engine = exports['serp_coloration']
        types = {
...
function drawnBoxes()
    ...
    for k,v in ipairs(cache) do
        ...
        dxDrawRectangle(pos[1], pos[2], boxWidth, 50, tocolor(21, 21, 21, alpha[1]),true)
        ...
        dxDrawRectangle(pos[1], pos[2] + 0, timeLineSize, 2, tocolor(r, g, b, alpha[3]),true)
