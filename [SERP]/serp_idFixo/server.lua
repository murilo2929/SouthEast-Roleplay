...
function playerJoin()
	...
	idforname = "Roleplay-" .. getElementData(source, "playerid") .. ""
...
function fakeMyID()
	...
	ids[slot] = source
	exports.ed_anticheat:changeProtectedElementDataEx(source, "playerid", slot)
	exports.ed_pool:allocateElement(source, slot)
end
