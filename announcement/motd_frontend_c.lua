...
function displayOneMotd()
    ...
    if pointer and motds and #motds>0 and motds[pointer] then
        ...
        GUIEditor.window[1] = guiCreateWindow(491, 193, 800, 369, "Mensagem do Dia! - "..motds[pointer].title, false)
        ...
        GUIEditor.button[1] = guiCreateButton(666, 330, 124, 29, "Fechar", false, GUIEditor.window[1])
        GUIEditor.checkbox[1] = guiCreateCheckBox(522, 335, 144, 14, "Não mostre isso de novo", false, false, GUIEditor.window[1])
